...
if (temp === "A") {
	...
	} else if ((B === 2 && A === 3) || (A === 2 && B === 3) || (A === 3 && B === 3) || (A === 2 && B === 2 && C === 1)) {
	...
	} else if ((C === 2 && A === 3) || (A === 2 && C === 3) || (A === 3 && C === 3) || (A === 2 && C === 2 && B === 1)) { 
	...
	} else if ((D === 2 && A === 3) || (A === 2 && D === 3) || (A === 3 && D === 3) || (A === 2 && D === 2 && B === 1)) {
	...
	} else if ((C === 2 && B === 3) || (B === 2 && C === 3) || (B === 3 && C === 3) || (B === 2 && C === 2 && A === 1)) {
	...
	} else if ((B === 2 && D === 3) || (D === 2 && B === 3) || (D === 3 && B === 3) || (D === 2 && B === 2) && A === 1) {
